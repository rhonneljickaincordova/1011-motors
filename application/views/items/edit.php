<?php $this->load->view('layout/header'); ?>
	...
	<br>
	<?php echo form_open('items/edit/' . $item->get_id(), 'class="form-horizontal"'); ?>
		...
		<?php endif; ?>
			...
			<div class="col-lg-11">
				<?php echo form_input('description', set_value('description', $item->get_description()), 'class="form-control" required'); ?>
