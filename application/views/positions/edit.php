<?php $this->load->view('layout/header'); ?>
	...
	<br>
	<?php echo form_open('positions/edit/' . $position->get_id(), 'class="form-horizontal"'); ?>
		...
		<?php endif; ?>
			...
			<div class="col-lg-11">
				<?php echo form_input('description', set_value('description', $position->get_description()), 'class="form-control" required'); ?>
