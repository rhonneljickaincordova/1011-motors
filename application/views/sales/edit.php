<?php $this->load->view('layout/header'); ?>
	...
	<br>
	<?php echo form_open('sales/edit/' . $sale->get_id(), 'class="form-horizontal"'); ?>
		...
		<?php endif; ?>
			...
			<div class="col-lg-11">
				<?php echo form_input('customer', set_value('customer', $sale->get_customer()), 'class="form-control" required'); ?>
		...
		<?php endif; ?>
			...
			<div class="col-lg-11">
				<?php echo form_input('quantity', set_value('quantity', $sale->get_quantity()), 'class="form-control" required'); ?>
		...
		<?php endif; ?>
			...
			<div class="col-lg-11">
				<?php echo form_dropdown('item_id', $items, set_value('item_id', $sale->get_item_id()->get_id()), 'class="form-control" data-live-search="true" required'); ?>
		...
		<?php endif; ?>
			...
			<div class="col-lg-11">
				<?php echo form_input('price', set_value('price', $sale->get_price()), 'class="form-control" required'); ?>
		...
		<?php endif; ?>
			...
			<div class="col-lg-11">
				<?php echo form_input('remarks', set_value('remarks', $sale->get_remarks()), 'class="form-control" required'); ?>
